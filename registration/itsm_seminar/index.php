...
<?php
	if(isset($_POST['btnsubmit'])){
		...
		if(mysqli_num_rows($checksqlresult)==0){
			echo("<script>alert('There is no such student ID stored in the database, or you are from AppDev or NetAd. Approach the server about this problem or consider re-entering your student ID number.');window.location='index.php';</script>");
		}
		//have record
		else{
