    ...
    <div class="row">
        <div class="col-md-8">
        	<div class="Studentinfo">
				...
				$viewquery = "select studenttbl.student_name,event3.time_in,studenttbl.student_section,event3.student_id from event3 join studenttbl where studenttbl.student_idnumber=event3.student_id order by student_name";
