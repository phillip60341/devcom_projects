    ...
    <div class="row">
        <div class="col-md-8">
        	<div class="Studentinfo">
				...
				$viewquery = "select studenttbl.student_name,event2.time_in,studenttbl.student_section,event2.student_id from event2 join studenttbl where studenttbl.student_idnumber=event2.student_id order by student_name";
