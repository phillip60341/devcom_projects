...
<div class="heading">
	...
	<div class="eventtitle">
		...
		<p id="gen" >Life Skills Seminar</p>
		<p id="year" >2016</p>
		<p id="uni" >UNIVERSITY OF MAKATI</p>
		<p id="col" >COLLEGE OF COMPUTER SCIENCE</p>
		<p id="grand">MAIN THEATER | 1:00PM - 5:00PM</p>
...
<?php
	if(isset($_POST['btnsubmit'])){
		...
		//have record
			...
			$checksql1 = "select * from event4 where student_id='".$student_id."'"; 
			$checksqlresult1 = mysqli_query($connection,$checksql1);
			//pag hindi pa
			if(mysqli_num_rows($checksqlresult1)==0){
				$addquery = "insert into event4 values('".$student_id."',now())";
