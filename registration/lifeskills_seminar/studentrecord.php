    ...
    <div class="row">
        <div class="col-md-8">
        	<div class="Studentinfo">
				...
				$viewquery = "select studenttbl.student_name,event4.time_in,studenttbl.student_section,event4.student_id from event4 join studenttbl where studenttbl.student_idnumber=event4.student_id order by student_name";
		...
		<div class="attendees">
			...
			$countsql = "select count(studenttbl.student_name) as 'count(*)' from event4 join studenttbl where studenttbl.student_idnumber=event4.student_id order by student_name";
