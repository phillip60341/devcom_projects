	...
	<div class="whole_container">
		...
		<form action="" method="POST">
			<div class="candidate_container">
				...
				?>
						<div class="candidate lightBlue" onclick=<?php echo('"cand_onclick('.$viewcandrow['id'].',1)"'); ?> id=<?php echo('"'.$viewcandrow['id'].'candidate"'); ?>>
			...
			<div class="candidate_container">
				...
				<?php
					...
					while($viewcandrow=mysqli_fetch_assoc($viewcandresult)){?>
						<div class="candidate lightYellow" onclick=<?php echo('"cand_onclick('.$viewcandrow['id'].',2)"'); ?>>
			...
			<div class="candidate_container">
				...
				<?php
					...
					while($viewcandrow=mysqli_fetch_assoc($viewcandresult)){?>
						<div class="candidate lightBlue" onclick=<?php echo('"cand_onclick('.$viewcandrow['id'].',3)"'); ?>>
							<div class="candidate_photo">
								<img src="images/classprofile.png" width="100%">
							</div>
							<div class="candidate_details">
			...
			<div class="candidate_container">
				...
				<?php
					...
					while($viewcandrow=mysqli_fetch_assoc($viewcandresult)){?>
						<div class="candidate lightYellow" onclick=<?php echo('"cand_onclick('.$viewcandrow['id'].',4)"'); ?>>
							<div class="candidate_photo">
								<img src="images/classprofile.png" width="100%">
							</div>
							<div class="candidate_details">
			...
			<div class="candidate_container">
				...
				<?php
					...
					while($viewcandrow=mysqli_fetch_assoc($viewcandresult)){?>
						<div class="candidate lightBlue" onclick=<?php echo('"cand_onclick('.$viewcandrow['id'].',5)"'); ?>>
							<div class="candidate_photo">
								<img src="images/classprofile.png" width="100%">
							</div>
							<div class="candidate_details">
			...
			<div class="candidate_container" id="representative_candidate" <?php rep_voting($viewnamerow['year_level'],"3rd Year"); ?> >
				...
				<?php
					...
					while($viewcandrow=mysqli_fetch_assoc($viewcandresult)){?>
						<div class="candidate lightYellow" onclick=<?php echo('"cand_onclick('.$viewcandrow['id'].',6)"'); ?>>
							<div class="candidate_photo">
								<img src="images/classprofile.png" width="100%">
							</div>
							<div class="candidate_details">
...
<?php
	if(isset($_POST['btnSubmit'])){
		...
		$numberwho = $_POST['contact_num'];
		$deviceID = 39768;
		$number = '+63'.'$numberwho';
		$message = 'Ang pogi ko talaga!!!';
		/*
